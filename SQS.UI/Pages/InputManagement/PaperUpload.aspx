                                ...
                                <Rows>
                                    <x:FormRow ID="FormRow1" runat="server">
                                        <Items>
                                            ...
                                            <x:TextBox ID="TextBox_PaperName" runat="server" Label="论文名称" Text="" EmptyText="请输入论文名称">
                                            </x:TextBox>
                                        </Items>
                                    </x:FormRow>
                                    ...
                                    <x:FormRow ID="FormRow2" runat="server">
                                        <Items>
                                            <x:DatePicker ID="DatePicker_PublishDateStart" runat="server" Label="发表时间 从" EmptyText="点击右边图标选择日期"
                            ...
                            <x:Grid ID="Grid1" runat="server" Title="著作统计表" EnableRowNumber="true" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <x:WindowField ColumnID="WindowField_Modify" TextAlign="Center" Width="80px" WindowID="Window_Modify"
                                        HeaderText="操作" Text="修改" ToolTip="修改项目" Title="操作" IFrameUrl="iframe_ModifyPaperInformation.aspx"
                                        DataIFrameUrlFields="ID" DataIFrameUrlFormatString="iframe_ModifyPaperInformation.aspx?id={0}" />
                                </Columns>
                            </x:Grid>
                        </Items>
                    </x:Panel>
