<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iframe_ModifyBookInformation.aspx.cs"
    Inherits="SQS.UI.Pages.InputManagement.iframe_ModifyBookInformation" %>
                ...
                <Items>
                    <x:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="5px" Title="SimpleForm"
                        ...
                        <Items>
                            ...
                            <x:TextBox ID="TextBox_BookName" runat="server" Label="著作名称" Text="" Width="200px">
                            </x:TextBox>
                            <x:TextBox ID="TextBox_Press" runat="server" Label="出版社" Text="" Width="200px">
                            </x:TextBox>
                            <x:DatePicker ID="DatePicker_PublishDate" runat="server" Label="出版时间（年月）" Width="150px" DateFormatString="yyyy-MM">
                            </x:DatePicker>
                            ...
                            <x:DropDownList ID="DropDownList_AutherOrder" runat="server" Label="第几作者" Width="200px">
                                <x:ListItem EnableSelect="true" Text="编一" Value="1" />
                                <x:ListItem EnableSelect="true" Text="编二" Value="2" />
                                <x:ListItem EnableSelect="true" Text="编三" Value="3" />
                                <x:ListItem EnableSelect="true" Text="编四" Value="4" />
                                <x:ListItem EnableSelect="true" Text="编五以上（含）" Value="5" />
                            </x:DropDownList>
                        </Items>
                    </x:SimpleForm>
                </Items>
