...
{
    public partial class StaticalCountExport : PageBase
    {
        #region Page Init
        ...
        protected void Button_GetResult_Click(object sender, EventArgs e)
        {
            ...
            string exception = "";
            if (OutputManagementCtrl.GetCountResultForOffice(ref table, startTime, stopTime, ref exception))
            {
