        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false"
                ...
                <Items>
                        ...
                        <Rows>
                            <x:FormRow ID="FormRow1" runat="server">
                                <Items>
                                    ...
                                    <x:TextBox ID="TextBox_WorkName" runat="server" Label="著作、论文、课题名称" Text="" EmptyText="请输入著作名称">
                                    </x:TextBox>
                                </Items>
                            </x:FormRow>
                            ...
                            <x:FormRow ID="FormRow2" runat="server">
                                <Items>
                                    <x:DatePicker ID="DatePicker_PublishDateStart" runat="server" Label="出版、发表、结题时间 从"
                                        EmptyText="点击右边图标选择日期" DateFormatString="yyyy-m">
                                    </x:DatePicker>
                    ...
                    <x:Grid ID="Grid_Paper" runat="server" Title="论文统计表" EnableRowNumber="true" AllowPaging="true"
                    ...
                    <x:Grid ID="Grid_Book" runat="server" Title="著作统计表" EnableRowNumber="true" AllowPaging="true"
                        PageSize="5" Height="200px" AutoScroll="true">
                        <Columns>
                            <x:BoundField Width="150px" DataField="Depart" DataFormatString="{0}" HeaderText="部系单位" />
                            <x:BoundField Width="150px" DataField="Office" DataFormatString="{0}" HeaderText="处室单位" />
                    ...
                    <x:Grid ID="Grid_Topic" runat="server" Title="课题统计表" EnableRowNumber="true" AllowPaging="true"
                        PageSize="5" Height="200px" AutoScroll="true">
                        <Columns>
                            <x:BoundField Width="150px" DataField="Depart" DataFormatString="{0}" HeaderText="部系单位" />
                            <x:BoundField Width="150px" DataField="Office" DataFormatString="{0}" HeaderText="处室单位" />
