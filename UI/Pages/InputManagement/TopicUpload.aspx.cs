...
namespace SQS.UI.Pages.InputManagement
{
    public partial class TopicUpload : PageBase
    {
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (InputManagementCtrl.DeleteTopicsByIds(IDs, ref exception))
            {
        ...
        protected void Button_Export_Click(object sender, EventArgs e)
        {
            ...
            string fileName = "";
            if (ExportManagementCtrl.ExportTopicInformation(ref fileName, table, ref exception))
            {
                Response.ClearContent();
        ...
        private void bindTopicInformationToGrid()
        {
            string exception = "";
            DataTable table = new DataTable();
            if (InputManagementCtrl.GetAllTopicInformation(ref table, ref exception))
            {
                Grid1.DataSource = table;
                Grid1.DataBind();
            }
